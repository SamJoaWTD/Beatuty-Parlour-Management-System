...
<section class="w3l-contact-info-main" id="contact">
    ...
    <div class="cont-right">
        <h6>Call Us</h6>
        <p class="para"><a href="tel:+7826045193">+7826045193</a></p>
    </div>
</div>
<div class="cont-top margin-up">
    ...
    <div class="cont-right">
        <h6>Email Us</h6>
        <p class="para"><a href="mailto:samhita162004@gmail.com" class="mail">samhita162004@gmail.com@gmail.com</a></p>
    </div>
</div>
<div class="cont-top margin-up">
    <div class="cont-left text-center">
    ...
    <div class="cont-right">
        <h6>Address</h6>
        <p class="para">418A, Transport nagar, Madurai</p>
    </div>
</div>
<div class="cont-top margin-up">
    <div class="cont-left text-center">
    ...
    <div class="cont-right">
        <h6>Time</h6>
        <p class="para">10:30 am to 7:30 pm</p>
    </div>
</div>
 </div>
